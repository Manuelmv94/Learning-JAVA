public class Clock{
	...
	public Clock(){
		this(6,30,0,"Guadalajara"); //tiene que ser la primer linea de codigo
	...
	public void printTime(){
		...
		System.out.println("La hora en "+this.cd+ " es "+hora+":"+minuto+":"+segundo);
	}
	...
	public String toString(){
		...
		return ("La hora en "+this.cd+ " es "+hora+":"+minuto+":"+segundo);
